  ...
  return (
    ...
    <header className="w-full h-16 border-b border-gray-200 dark:border-border-accent/30 bg-white dark:bg-background flex items-center justify-between px-6 shrink-0 z-10 sticky top-0">
      ...
      <div className="flex items-center gap-4 text-sm font-medium text-gray-500 dark:text-gray-400">
        {/* Visualización del Rol Activo (Desktop) */}
        {mounted && user && (
        ...
        {/* Botón hamburguesa móvil (Siempre visible en celular si hay usuario) */}
        {mounted && user && (
          <button
      ...
      {/* Menú desplegable móvil - Colocado dentro del header para que herede el posicionamiento sticky */}
      {mobileMenuOpen && (
